...
FRACTIONAL_KELLY = 0.50     # fraction of full Kelly to wager
MAX_KELLY = 0.10            # per-bet bankroll cap
TOP_N_BETS_PER_DAY = 5      # max bets selected per game-day
DAILY_MAX_EXPOSURE = 0.25   # max total bankroll at risk per day

# --- Model specs ---
# List of dicts with keys: id (str), model (estimator), needs_imputer (bool)
MODEL_SPECS = [
    {
        "id": "lgb_v1",
...
# --- Ensemble weighting ---
# "inverse_rmse" | "equal" | dict of {model_id: weight}
ENSEMBLE_WEIGHTS = "inverse_rmse"

# --- Feature exclusions / inclusions (exact column names) ---
EXTRA_FEATURE_EXCLUSIONS: list[str] = []
EXTRA_FEATURE_INCLUSIONS: list[str] = []

# --- Dean Oliver / Pythagorean constants (tunable) ---
