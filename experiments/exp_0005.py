...
MODEL_SPECS = [
    ...
    {"id": "xgb_v1", "model": XGBRegressor(n_estimators=300, learning_rate=0.05,
      max_depth=4, reg_alpha=0.1, reg_lambda=1.5, subsample=0.8, colsample_bytree=0.8, verbosity=0, random_state=42),
     "needs_imputer": False},
]
